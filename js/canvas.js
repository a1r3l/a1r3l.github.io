...
Canvas.prototype.init = function(){
	...
	this.createLamp(-280,0,65);
	this.createSideBuildings(539,78,0);
	this.createSkybox();
	this.createDrawPlane(-256,32,2);
	this.createDrawPlane(-128,32,2);
	this.createDrawPlane(256,32,2);
	this.createDrawPlane(128,32,2);
...
Canvas.prototype.createAcera = function(){
	...
	var lateralTexture = new THREE.ImageUtils.loadTexture('imgs/baldosa.jpg');
...
Canvas.prototype.createSceneWalls = function(){
...
Canvas.prototype.createSideBuildings = function(x,y,z) {
	var geometry = new THREE.PlaneGeometry(1200,200);
	var textureLoader = new THREE.TextureLoader();
	var texture = textureLoader.load('imgs/sidebuild.png');
